...
### Step by step procedure
  ...
  1. In the AWS services select &#8216;Elastic Bean&#8217;.
    ...
    <img class="alignnone size-full wp-image-971" src="https://i1.wp.com/marco.dev/wp-content/uploads/2017/03/1.png?resize=355%2C200" data-recalc-dims="1" />
  ...
  3. Choose a name and write a description to your application.
    ...
    <img class="alignnone wp-image-958" src="https://i0.wp.com/marco.dev/wp-content/uploads/2017/03/3.png?resize=310%2C191" data-recalc-dims="1" />
  4. This will create your environment, you need to generate a new application. Click on &#8216;create one now&#8217;.
  
    <img class="alignnone wp-image-966" src="https://i0.wp.com/marco.dev/wp-content/uploads/2017/03/4.png?resize=428%2C77" data-recalc-dims="1" />
  5. Choose &#8216;Web server environment&#8217;.
  
    <img class="alignnone wp-image-969" src="https://i0.wp.com/marco.dev/wp-content/uploads/2017/03/5.png?resize=330%2C216" data-recalc-dims="1" />
  6. Select Java in the &#8216;Preconfigured platform&#8217;.
  
    <img class="alignnone wp-image-975" src="https://i1.wp.com/marco.dev/wp-content/uploads/2017/03/6.png?resize=355%2C213" data-recalc-dims="1" />
  7. Don&#8217;t change the option in &#8216;Application code&#8217;. AWS will install a default application.
  
    <img class="alignnone wp-image-961" src="https://i0.wp.com/marco.dev/wp-content/uploads/2017/03/7.png?resize=345%2C170" data-recalc-dims="1" />
  8. At this point you can &#8216;Create environment&#8217; to create your server instance.
  
    <img class="alignnone wp-image-967" src="https://i1.wp.com/marco.dev/wp-content/uploads/2017/03/10.png?resize=355%2C46" data-recalc-dims="1" />
 ...
 10. After the confirmation the server instance is created and the demo application deployed.
    ...
    <img class="alignnone wp-image-964" src="https://i1.wp.com/marco.dev/wp-content/uploads/2017/03/9.png?resize=372%2C71" data-recalc-dims="1" /><img class="alignnone wp-image-968" src="https://i0.wp.com/marco.dev/wp-content/uploads/2017/03/11.png?resize=382%2C200" data-recalc-dims="1" /><img class="alignnone size-full wp-image-970" src="{{site.baseurl}}/assets/img/uploads/2017/03/12.png?resize=400%2C132" data-recalc-dims="1" />
 ...
 13. To deploy your application you have to click on &#8216;Upload and Deploy&#8217; in your dashboard.
    ...
    <img class="alignnone size-full wp-image-963" src="https://i0.wp.com/marco.dev/wp-content/uploads/2017/03/15.png?resize=220%2C121" data-recalc-dims="1" />
 14. Upload the war that you want to deploy and give a version name to this deploy, e.g. : &#8216;My First app version 1.0&#8217;. All the deployments are archived in S3 and you can easily redeploy a previous version.
    ...
    <img class="alignnone size-full wp-image-959" src="https://i1.wp.com/marco.dev/wp-content/uploads/2017/03/19.png?resize=350%2C188" data-recalc-dims="1" />
